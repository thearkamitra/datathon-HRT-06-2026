"""Training labels for the probabilistic-regression pipeline.

The competition Sharpe metric scores ``w_i * R_i`` where

    R_i = close_end_i / close_half_i - 1

and for the train set the end close is present in
